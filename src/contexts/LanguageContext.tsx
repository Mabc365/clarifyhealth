...
const strings: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Home
    "home.hero": "Health information, in plain English.",
    "home.sub": "Skip the jargon. Get clear answers to common health questions, reviewed by clinicians.",
    "home.cta": "Ask a health question",
    "home.card1.h": "Explained simply",
    "home.card1.p": "Plain-English explainers for common conditions and tests.",
    "home.card2.h": "Reviewed by clinicians",
    "home.card2.p": "Every article checked by a licensed medical professional.",
    "home.card3.h": "Built for questions",
    "home.card3.p": "Ask anything — get a clear answer in seconds.",
    "home.how": "How it works",
    "home.step1": "Type a question or browse our library of conditions.",
    "home.step2": "Read a short, plain-English explainer reviewed by a clinician.",
    "home.step3": "Bring the right questions to your next appointment.",
    "home.exampleLabel": "Example",
    "home.exampleTitle": "What is type 2 diabetes, really?",
    "home.exampleSub": "A short, plain-English explainer of what's happening in your body, what the numbers mean, and what to ask your doctor.",
    "home.exampleRead": "Read the article",
    "home.finalH": "Get a clear answer.",
    "home.finalNote": "Free. No account needed.",
  },
  es: {
    // Nav / global
    "nav.topics": "Temas",
    ...
    // Home
    "home.hero": "Información de salud, en lenguaje sencillo.",
    "home.sub": "Olvídate de la jerga. Respuestas claras a preguntas comunes de salud, revisadas por profesionales.",
    "home.cta": "Haz una pregunta de salud",
    "home.card1.h": "Explicado con sencillez",
    "home.card1.p": "Explicaciones en lenguaje sencillo de condiciones y pruebas comunes.",
    "home.card2.h": "Revisado por profesionales",
    "home.card2.p": "Cada artículo verificado por un profesional médico licenciado.",
    "home.card3.h": "Hecho para preguntas",
    "home.card3.p": "Pregunta lo que sea — obtén una respuesta clara en segundos.",
    "home.how": "Cómo funciona",
    "home.step1": "Escribe una pregunta o explora nuestra biblioteca de condiciones.",
    "home.step2": "Lee una explicación breve y sencilla revisada por un profesional.",
    "home.step3": "Lleva las preguntas correctas a tu próxima cita.",
    "home.exampleLabel": "Ejemplo",
    "home.exampleTitle": "¿Qué es realmente la diabetes tipo 2?",
    "home.exampleSub": "Una explicación breve y sencilla de lo que ocurre en tu cuerpo, qué significan los números y qué preguntar a tu doctor.",
    "home.exampleRead": "Lee el artículo",
    "home.finalH": "Obtén una respuesta clara.",
    "home.finalNote": "Gratis. No necesitas cuenta.",
  },
  ur: {
    // Nav / global
    "nav.topics": "موضوعات",
    ...
    // Home
    "home.hero": "صحت کی معلومات، آسان زبان میں۔",
    "home.sub": "اصطلاحات سے بچیں۔ ڈاکٹروں کے جائزہ شدہ آسان جوابات حاصل کریں۔",
    "home.cta": "صحت کا سوال پوچھیں",
    "home.card1.h": "آسانی سے سمجھایا گیا",
    "home.card1.p": "عام بیماریوں اور ٹیسٹوں کی سادہ وضاحت۔",
    "home.card2.h": "ڈاکٹروں کا جائزہ",
    "home.card2.p": "ہر مضمون کا جائزہ ایک لائسنس یافتہ طبی پیشہ ور لیتا ہے۔",
    "home.card3.h": "سوالات کے لیے بنایا گیا",
    "home.card3.p": "کچھ بھی پوچھیں — سیکنڈوں میں واضح جواب پائیں۔",
    "home.how": "یہ کیسے کام کرتا ہے",
    "home.step1": "سوال لکھیں یا ہماری بیماریوں کی لائبریری دیکھیں۔",
    "home.step2": "ڈاکٹروں کی جائزہ شدہ ایک مختصر، آسان وضاحت پڑھیں۔",
    "home.step3": "اپنی اگلی ملاقات میں صحیح سوالات لے کر جائیں۔",
    "home.exampleLabel": "مثال",
    "home.exampleTitle": "ٹائپ 2 ذیابیطس اصل میں کیا ہے؟",
    "home.exampleSub": "آپ کے جسم میں کیا ہو رہا ہے، نمبروں کا کیا مطلب ہے، اور ڈاکٹر سے کیا پوچھنا ہے — اس کی مختصر، آسان وضاحت۔",
    "home.exampleRead": "مضمون پڑھیں",
    "home.finalH": "ایک واضح جواب حاصل کریں۔",
    "home.finalNote": "مفت۔ اکاؤنٹ کی ضرورت نہیں۔",
  },
  hi: {
    // Nav / global
    "nav.topics": "विषय",
    ...
    // Home
    "home.hero": "स्वास्थ्य जानकारी, सरल भाषा में।",
    "home.sub": "तकनीकी शब्दों को छोड़ें। चिकित्सकों द्वारा समीक्षित आम स्वास्थ्य प्रश्नों के स्पष्ट उत्तर पाएं।",
    "home.cta": "एक स्वास्थ्य प्रश्न पूछें",
    "home.card1.h": "सरलता से समझाया गया",
    "home.card1.p": "सामान्य स्थितियों और जांचों की सरल भाषा में व्याख्या।",
    "home.card2.h": "चिकित्सकों द्वारा समीक्षित",
    "home.card2.p": "हर लेख की समीक्षा एक लाइसेंस प्राप्त चिकित्सक द्वारा की जाती है।",
    "home.card3.h": "प्रश्नों के लिए बनाया गया",
    "home.card3.p": "कुछ भी पूछें — सेकंडों में स्पष्ट उत्तर पाएं।",
    "home.how": "यह कैसे काम करता है",
    "home.step1": "एक प्रश्न लिखें या हमारी स्थितियों की लाइब्रेरी देखें।",
    "home.step2": "चिकित्सक द्वारा समीक्षित एक संक्षिप्त, सरल भाषा में व्याख्या पढ़ें।",
    "home.step3": "अपनी अगली मुलाकात में सही प्रश्न लेकर जाएं।",
    "home.exampleLabel": "उदाहरण",
    "home.exampleTitle": "टाइप 2 मधुमेह वास्तव में क्या है?",
    "home.exampleSub": "आपके शरीर में क्या हो रहा है, संख्याओं का क्या अर्थ है, और डॉक्टर से क्या पूछना है — इसकी एक संक्षिप्त, सरल व्याख्या।",
    "home.exampleRead": "लेख पढ़ें",
    "home.finalH": "एक स्पष्ट उत्तर पाएं।",
    "home.finalNote": "मुफ्त। खाते की आवश्यकता नहीं।",
  },
  ar: {
    // Nav / global
    "nav.topics": "المواضيع",
    ...
    // Home
    "home.hero": "معلومات صحية، بلغة بسيطة.",
    "home.sub": "تخطَّ المصطلحات الطبية. احصل على إجابات واضحة لأسئلة الصحة الشائعة، مراجعة من قبل أطباء.",
    "home.cta": "اطرح سؤالًا صحيًا",
    "home.card1.h": "موضح ببساطة",
    "home.card1.p": "شروحات بلغة بسيطة للحالات والفحوصات الشائعة.",
    "home.card2.h": "تمت مراجعته من قبل أطباء",
    "home.card2.p": "كل مقال يراجعه طبيب مرخص.",
    "home.card3.h": "مصمم للأسئلة",
    "home.card3.p": "اسأل أي شيء — احصل على إجابة واضحة في ثوانٍ.",
    "home.how": "كيف يعمل",
    "home.step1": "اكتب سؤالاً أو تصفّح مكتبتنا من الحالات.",
    "home.step2": "اقرأ شرحًا قصيرًا بلغة بسيطة مراجعًا من قبل طبيب.",
    "home.step3": "خذ الأسئلة الصحيحة إلى موعدك القادم.",
    "home.exampleLabel": "مثال",
    "home.exampleTitle": "ما هو داء السكري من النوع 2 حقًا؟",
    "home.exampleSub": "شرح قصير وبسيط لما يحدث في جسمك، ومعنى الأرقام، وما الذي يجب سؤال طبيبك عنه.",
    "home.exampleRead": "اقرأ المقال",
    "home.finalH": "احصل على إجابة واضحة.",
    "home.finalNote": "مجاني. لا حاجة لحساب.",
  },
};
